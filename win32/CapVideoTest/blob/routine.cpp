...
public:
	...
	COM_METHOD(HRESULT, Reset)(THIS_ D3DPRESENT_PARAMETERS* pPresentationParameters) { /*TODO*/ return m_ptr->Reset(pPresentationParameters); }
	...
	COM_METHOD(HRESULT, SetRenderTarget)(THIS_ DWORD RenderTargetIndex,IDirect3DSurface9* pRenderTarget) { /*TODO*/ return m_ptr->SetRenderTarget(RenderTargetIndex, pRenderTarget); }
	...
	COM_METHOD(HRESULT, BeginScene)(THIS) { /*TODO*/ return m_ptr->BeginScene(); }
	COM_METHOD(HRESULT, EndScene)(THIS) {  return m_ptr->EndScene(); }
	...
	COM_METHOD(HRESULT, DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE Type,INT BaseVertexIndex,UINT MinVertexIndex,UINT NumVertices,UINT startIndex,UINT primCount) { /*TODO*/ return m_ptr->DrawIndexedPrimitive(Type, BaseVertexIndex, MinVertexIndex, NumVertices, startIndex, primCount); }
