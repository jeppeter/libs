...
set DEVENVPATH=C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE
...
cd ..\VBoxDD
"%DEVENVPATH%\devenv" VBoxDD.sln /Build "%CONFIGNAME%|Win32"
if not exist %CONFIGNAME%\VBoxDD.dll goto error
"%DEVENVPATH%\devenv" VBoxDD.sln /Build "%CONFIGNAME%|x64"
if not exist x64\%CONFIGNAME%\VBoxDD.dll goto error

mkdir ..\bundle\%TARGETSUBPATH%VirtualBox
mkdir ..\bundle\%TARGETSUBPATH%VirtualBox\x86
mkdir ..\bundle\%TARGETSUBPATH%VirtualBox\x64

copy /y %CONFIGNAME%\VBoxDD.dll ..\bundle\%TARGETSUBPATH%VirtualBox\x86
copy /y %CONFIGNAME%\VBoxDD.pdb ..\bundle\%TARGETSUBPATH%VirtualBox\x86
copy /y x64\%CONFIGNAME%\VBoxDD.dll ..\bundle\%TARGETSUBPATH%VirtualBox\x64
copy /y x64\%CONFIGNAME%\VBoxDD.pdb ..\bundle\%TARGETSUBPATH%VirtualBox\x64
