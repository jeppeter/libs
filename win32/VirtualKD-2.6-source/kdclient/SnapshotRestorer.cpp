...
HRESULT StartRevertingCurrentVMToLastSnapshot()
{
	...
	BazisLib::Win32::Process process(BazisLib::String::sFormat(L"rundll32 \"%s\",VMSnapshotRevertingEntry /VMXFILE:%s", tszDll, vmFile.c_str()).c_str(), (WORD)SW_SHOW);
	return S_OK;
}
...
extern "C" void __declspec(dllexport) VMSnapshotRevertingEntry()
{
